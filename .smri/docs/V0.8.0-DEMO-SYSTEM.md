# 🎬 v0.8.0 Demo System - Complete Presentation
...
**Steps:**
1. ✅ Clear All Data (KV Manager)
   - Show KV Manager UI
   - Click "Clear All KV"
   - Confirm all namespaces empty

2. ✅ Import CSV (Real Snakes)
   - Upload `data/snakes-24.csv`
   - Show parser preview
   - Validate: Name, Morph, Gender, YOB, Weight

3. ✅ Create Stripe Products
   - For each CSV row → Create Stripe product
   - Show API calls
   - Display Stripe dashboard

4. ✅ Sync to KV (PRODUCTS_REAL)
   - Fetch from Stripe → Write to KV
   - Show KV Manager update
   - 24 products appear

5. ✅ Set Prices
   - Batch price update
   - Default €150 or custom
...
├─────────────────────────────────────────────┤
│  Progress: [████████░░░░░░░░░░] 40%        │
│  Step 2 of 5: Import CSV                    │
│                                             │
│  ┌─────────────────────────────────────┐   │
│  │ [Live Output Window]                │   │
│  │                                     │   │
│  │ ✅ CSV loaded: 24 snakes            │   │
│  │ ⏳ Validating data...               │   │
│  │ ✅ All rows valid                   │   │
...
```
debug/
├── demo-orchestrator.html          # Main demo UI
├── demo-pipelines.js               # Pipeline definitions
├── demo-engine.js                  # Step execution engine
├── demo-styles.css                 # Presentation styling
├── pipelines/
│   ├── owner-setup.js              # Pipeline 1
│   ├── customer-purchase.js        # Pipeline 2
│   ├── farm-gameplay.js            # Pipeline 3
│   └── data-management.js          # Pipeline 4
└── assets/
    ├── icons/                      # Step icons
