...
1. Load catalog with multiple Banana morphs available
2. Purchase first Banana snake (Male)
3. Verify collection shows 1 Banana
4. Return to catalog page
5. Purchase second Banana snake (Female)
6. Verify collection shows 2 Banana snakes
7. Verify both have unique product IDs
8. Verify collection distinguishes between them
9. Verify no data overwrite occurred
10. Verify breeding calculator can detect the pair
