...
- Verify: Console shows "✅ Loaded X morphs + Y combos from genetics database v2.0.0"
...
- Expected outcomes:
  - Spider: 50%
  - Normal: 50%
- Verify: ⚠️ Health warning appears (Spider wobble)
...
- Female: Spider
- Click "Calculate"
- Expected: 🚫 LETHAL COMBINATION alert
...
- Click "Calculate"
- Verify: 💰 Market Value card appears
...
- [ ] Exact match: "Banana" → "Banana"
- [ ] Alias match: "Coral Glow" → "Banana"
- [ ] Tag system: Click to add, × to remove
...
- [ ] Lethal detection: Blocks Spider × Spider, Lesser × Butter
...
3. **Line compatibility:** Axanthic VPI × TSK won't detect incompatibility (future enhancement)
...
```
🧬 Initializing breeding calculator...
✅ Loaded 20 morphs + 10 combos from genetics database v2.0.0
✅ Genetics database loaded
```
