...
1. Load catalog page at /catalog.html
2. Wait for product cards to render from KV
3. Verify at least 1 product card is visible
4. Click first available product card
5. Verify product modal opens with details
6. Click "Checkout" button in modal
7. Verify Stripe checkout session initiated
8. Complete Stripe test payment flow
9. Verify webhook assigns product to user KV
10. Navigate to /success.html page
11. Verify success message displays
12. Click link to view collection
13. Navigate to /collection.html page
14. Verify purchased snake appears in collection
