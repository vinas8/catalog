...
### **SMRI Fabric Integration**
**File:** [`docs/guides/SMRI-FABRIC-INTEGRATION.md`](guides/SMRI-FABRIC-INTEGRATION.md)  
**Purpose:** AI-powered scenario generation with Fabric  
**When to use:** Automate scenario creation, code review

### **Fabric Patterns**
**Location:** [`.fabric/patterns/`](../.fabric/patterns/)  
**Patterns:**
...
4. Use `docs/guides/SMRI-FABRIC-INTEGRATION.md` (automation)
...
3. Use `docs/guides/SMRI-FABRIC-INTEGRATION.md` (generate scenarios from stories)
...
2. If not, add scenario (use Fabric pattern)
...
2. Use Fabric `smri_code_reviewer` pattern
...
├── guides/
│   └── SMRI-FABRIC-INTEGRATION.md   # Fabric AI guide
└── archive/
    └── (old versions)
