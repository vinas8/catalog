# 🎉 Serpent Town v0.5.0 - SMRI System Complete
...
v0.5.0 marks the completion of the **SMRI (Scenario–Module–Relation–Instance)** system infrastructure. Serpent Town is now the first project to use documentation-driven, scenario-first development at scale.
...
**Files:**
- `docs/v0.5.0.md` - Complete system documentation (17k words)
...
1. **Read the notation guide:**
   ```bash
   cat docs/v0.5.0.md | grep -A 50 "SMRI System"
   ```
...
- **v0.5.0 Complete Guide:** `docs/v0.5.0.md`
